...
public class MainPage {
    ...
    private final By atticOrderButton = By.cssSelector(".Button_Button__ra12g");
    private final By bigOrderButton = By.cssSelector(".Button_UltraBig__UU3Lp");
    ...
    public void choiceOrderButton(boolean choiceOrderButton) {
        By orderButton = (choiceOrderButton) ? atticOrderButton : bigOrderButton;
